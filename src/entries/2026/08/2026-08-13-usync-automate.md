...
- Released [`v17.0.0-beta1`](https://github.com/Jumoo/uSync.Automate/releases/tag/v17.0.0-beta1) (3 packages) to NuGet and made the repo public — fixed `RepositoryUrl` (still pointed at `KevinJump/`), added badges, community health files, and a `umbraco-marketplace.json` per package
