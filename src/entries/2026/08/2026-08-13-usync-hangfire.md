...
- Switched release publishing to [NuGet](https://www.nuget.org/packages/uSync.Hangfire) trusted publishing; fixed the `dotnet nuget push` glob on Windows runners
